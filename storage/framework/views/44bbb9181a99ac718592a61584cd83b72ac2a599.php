...
<br/>
                ...
                <div class="row d-flex justify-content-around">
                    ...
                    <div class="card mb-4 col-6" style="max-width: 23rem;">
                        <div class="card-header text-center text-uppercase font-weight-bold topo"><h5><?php echo e($disciplina->nome); ?></h5></div>
                            <div>
                                <div>
                                ...
                                <br/>
                            <h5 class="text-center">Faltas: <?php echo e($disciplina->total_faltas); ?></h5>
                            <h5 class="text-center">Máximo de faltas: <?php echo e($disciplina->maximo_faltas); ?></h5>
                            <div class="row d-flex justify-content-around">                        
                                <div>                                
                                ...
                                <div>
                                    <a href="/disciplina/<?php echo e($disciplina->id); ?>/edit" class="btn btn-dark font-weight-bold"> Editar</a>
                                </div>
                                <div>
                                    <form action="/disciplina/<?php echo e($disciplina->id); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("template.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\prova\resources\views/disciplina/index.blade.php ENDPATH**/ ?>